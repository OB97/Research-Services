...
function onEdit(e) {
  ...
  // DEFINITIONS: Could be a waste to save everything on each edit, but I feel the computation is arbitrary //
  ...
  if(sh.getName() == "Spin Off or Startup from the Institution w/o IP Assignment"){}
  if(sh.getName() == "Supporting Start-ups/Scale-ups"){}
  if(sh.getName() == "Ecosystem Partnerships and Projects"){}
  if(sh.getName() == "Committees & Boards Supported by Members"){}
  if(sh.getName() == "Network members Collaboration and Support"){}
  if(sh.getName() == "Joint Network Member Events"){}
  if(sh.getName() == "Workshops with Industry"){}

  // if on companies engaged sheet
  if(sh.getName() == "Total Companies Engaged"){

    // if editing company info
    if(curRow >= 5 && curCol >= 2 && curCol <= 4){
      if(sh.getRange(curRow, 4).getValue() != ""){
        sh.getRange(curRow, 3).setValue(Session.getActiveUser().getEmail());
      }
      else{
        sh.getRange(curRow, 3).setValue("");
      }
    }
  }

  // if on member collaborations sheet
  if(sh.getName() == "Inter-Member Collaborations"){}
  ...
  if(curCol >= 6 && curCol <= 8 && curRow >= 5 && addedDate.valueOf() > q1Start.valueOf() && addedDate.valueOf() < q2Start.valueOf()){
    if(cellValue == "" && numMeetings == 0){newQ1.setValue(newQ1.getValue()-1);}
  ...
  if(curCol >= 10 && curCol <= 12 && curRow >= 5 && addedDate.valueOf() > q2Start.valueOf() && addedDate.valueOf() < q3Start.valueOf()){
    if(cellValue == "" && numMeetings == 0){newQ2.setValue(newQ2.getValue()-1);}
  ...
  if(curCol >= 14 && curCol <= 16 && curRow >= 5 && addedDate.valueOf() > q3Start.valueOf() && addedDate.valueOf() < q4Start.valueOf()){
    if(cellValue == "" && numMeetings == 0){newQ3.setValue(newQ3.getValue()-1);}
  ...
  if(curCol >= 18 && curCol <= 20 && curRow >= 5 && addedDate.valueOf() > q4Start.valueOf() && addedDate.valueOf() < q5Start.valueOf()){
    if(cellValue == "" && numMeetings == 0){newQ4.setValue(newQ4.getValue()-1);}
  ...
  if(curCol >= 22 && curCol <= 24 && curRow >= 5 && addedDate.valueOf() > q5Start.valueOf() && addedDate.valueOf() < q6Start.valueOf()){
    if(cellValue == "" && numMeetings == 0){newQ5.setValue(newQ5.getValue()-1);}
  ...
  if(curCol >= 26 && curCol <= 28 && curRow >= 5 && addedDate.valueOf() > q6Start.valueOf() && addedDate.valueOf() < q7Start.valueOf()){
    if(cellValue == "" && numMeetings == 0){newQ6.setValue(newQ6.getValue()-1);}
  ...
  if(curCol >= 30 && curCol <= 32 && curRow >= 5 && addedDate.valueOf() > q7Start.valueOf() && addedDate.valueOf() < q8Start.valueOf()){
    if(cellValue == "" && numMeetings == 0){newQ7.setValue(newQ7.getValue()-1);}
  ...
  if(curCol >= 34 && curCol <= 36 && curRow >= 5 && addedDate.valueOf() > q8Start.valueOf() && addedDate.valueOf() < q9Start.valueOf()){
    if(cellValue == "" && numMeetings == 0){newQ8.setValue(newQ8.getValue()-1);}
  ...
  if(curCol >= 38 && curCol <= 40 && curRow >= 5 && addedDate.valueOf() > q9Start.valueOf() && addedDate.valueOf() < q10Start.valueOf()){
    if(cellValue == "" && numMeetings == 0){newQ9.setValue(newQ9.getValue()-1);}
  ...
  if(curCol >= 42 && curCol <= 44 && curRow >= 5 && addedDate.valueOf() > q10Start.valueOf() && addedDate.valueOf() < q11Start.valueOf()){
    if(cellValue == "" && numMeetings == 0){newQ10.setValue(newQ10.getValue()-1);}
  ...
  if(curCol >= 46 && curCol <= 48 && curRow >= 5 && addedDate.valueOf() > q11Start.valueOf() && addedDate.valueOf() < q12Start.valueOf()){
    if(cellValue == "" && numMeetings == 0){newQ11.setValue(newQ11.getValue()-1);}
  ...
  if(curCol >= 50 && curCol <= 52 && curRow >= 5 && addedDate.valueOf() > q12Start.valueOf()){
    if(cellValue == "" && numMeetings == 0){newQ12.setValue(newQ12.getValue()-1);}
